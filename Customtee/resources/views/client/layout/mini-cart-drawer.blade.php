{{-- ============================================================
     FASHIONTEE MINI-CART DRAWER & FLOATING SIDE TRIGGER
     Thụt ra thụt vào từ cạnh phải màn hình — Fixed Flexbox 100vh
     ============================================================ --}}

{{-- Nút Tab Giỏ Hàng Nổi Cố Định Mép Phải Màn Hình --}}
<button type="button" class="fashion-side-cart-trigger d-flex flex-column align-items-center justify-content-center"
    ...
    <div class="position-relative d-flex align-items-center justify-content-center">
        ...
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger header-cart-badge {{ isset($headerCartCount) && $headerCartCount > 0 ? '' : 'd-none' }}" id="floatingSideCartBadge">
            {{ isset($headerCartCount) && $headerCartCount > 99 ? '99+' : ($headerCartCount ?? 0) }}
        </span>
    </div>
...
<div class="mini-cart-drawer" id="miniCartDrawer" aria-hidden="true" role="dialog" aria-modal="true">
    ...
    {{-- Thanh Tiến Trình Freeship Bar (Mốc 500k - Cố định dưới header) --}}
    ...
    {{-- Body Drawer (Cuộn độc lập, không làm tràn drawer) --}}
    <div class="mini-cart-body" id="miniCartBody">
        ...
        <div id="drawerCartGuest" class="d-none text-center py-5 px-3 my-auto">
            ...
            <div class="d-grid gap-2">
                <a href="{{ route('login') }}" class="btn btn-dark rounded-pill fw-semibold py-2 fs-8">
                    <i class="bi bi-box-arrow-in-right me-1"></i> Đăng nhập ngay
                </a>
                <a href="{{ route('register') }}" class="btn btn-outline-dark rounded-pill fw-semibold py-2 fs-8">
                    Tạo tài khoản mới
                </a>
            </div>
        </div>
        ...
        <div id="drawerCartEmpty" class="d-none text-center py-5 px-3 my-auto">
            ...
            <a href="{{ url('/Shop') }}" class="btn btn-dark rounded-pill px-4 py-2 fw-semibold fs-8" onclick="window.closeMiniCartDrawer()">
    ...
    {{-- Footer Drawer (Luôn ghim cố định ở đáy, không bao giờ bị đẩy mất) --}}
    <div class="mini-cart-footer border-top bg-white" id="drawerCartFooter" style="display: none;">
        ...
        <div class="d-grid gap-2">
            <a href="{{ route('dat-hang') }}" class="btn btn-dark rounded-pill py-2 fw-bold fs-7 shadow-xs d-flex align-items-center justify-content-center gap-1-5">
                <span>Tiến hành thanh toán</span>
                <i class="bi bi-arrow-right fs-7"></i>
            </a>
            <a href="{{ route('gio-hang.index') }}" class="btn btn-outline-dark rounded-pill py-1-5 fw-semibold fs-8" onclick="window.closeMiniCartDrawer()">
...
(function() {
    ...
    window.loadMiniCartData = function() {
        ...
        fetch('{{ route('api.cart.drawer-data') }}', {
            headers: {
