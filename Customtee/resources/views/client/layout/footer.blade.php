        ...
        <div class="row g-4 g-lg-5">
            ...
            <div class="col-12 col-lg-4">
                <div class="footer-brand-block mb-3">
                    <a href="{{ url('/') }}" class="text-decoration-none d-inline-flex align-items-center gap-1 mb-3">
            ...
            <div class="col-6 col-md-4 col-lg-2">
                ...
                <ul class="list-unstyled footer-link-list mb-0 fs-7 d-flex flex-column gap-2-5">
                    <li><a href="{{ url('/Shop') }}" class="footer-link">Tất cả sản phẩm</a></li>
                    @php
                        $footerCategories = \App\Models\Category::hienThi()->take(5)->get();
                    @endphp
                    @foreach ($footerCategories as $cat)
                        <li>
                            <a href="{{ url('/Shop?danh_muc[]=' . $cat->id) }}" class="footer-link">
                                {{ $cat->ten_danh_muc }}
                            </a>
                        </li>
                    @endforeach
                    <li><a href="{{ url('/Shop?sort=best_seller') }}" class="footer-link">Sản phẩm bán chạy</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                ...
                <ul class="list-unstyled footer-link-list mb-0 fs-7 d-flex flex-column gap-2-5">
                    <li><a href="{{ url('/Shop') }}" class="footer-link">Hướng dẫn chọn size</a></li>
                    <li><a href="{{ url('/Contact') }}" class="footer-link">Chính sách đổi trả</a></li>
                    <li><a href="{{ url('/Contact') }}" class="footer-link">Chính sách vận chuyển</a></li>
                    <li><a href="{{ url('/Contact') }}" class="footer-link">Chính sách bảo mật</a></li>
                    @auth
                        <li><a href="{{ route('order') }}" class="footer-link text-success fw-medium">Đơn hàng của tôi</a></li>
                    @else
                        <li><a href="{{ url('/login') }}" class="footer-link">Đăng nhập / Đăng ký</a></li>
                    @endauth
                    <li><a href="{{ url('/Contact') }}" class="footer-link">Liên hệ & Góp ý</a></li>
                </ul>
            </div>
            ...
            <div class="row align-items-center g-2 text-center text-md-start">
                <div class="col-12 col-md-6">
                    <p class="footer-text-muted small mb-0">
                        &copy; {{ date('Y') }} <strong class="text-white">FashionTee</strong>. Bản quyền thuộc về FashionTee Studio.
                    </p>
                </div>
                <div class="col-12 col-md-6 text-md-end">
                    <div class="d-inline-flex flex-wrap justify-content-center justify-content-md-end gap-3 small footer-text-muted">
                        <a href="{{ url('/Contact') }}" class="footer-legal-link">Điều khoản</a>
                        <a href="{{ url('/Contact') }}" class="footer-legal-link">Bảo mật</a>
                        <a href="{{ url('/Contact') }}" class="footer-legal-link">Hợp tác kinh doanh</a>
