        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
            <div>
                <h1 class="h3 fw-bold text-dark mb-1 tracking-tight">
                    Giỏ hàng <span class="text-muted fw-normal fs-6">(<?php echo e($items->count()); ?> sản phẩm)</span>
                </h1>
        ...
        <?php if($items->isEmpty()): ?>
            ...
            <div class="card border-0 shadow-sm rounded-4 text-center py-5 my-3 bg-white" id="cartEmptyState">
                <div class="card-body py-5 px-3">
                    ...
                    <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-dark rounded-pill px-4 py-2-5 fw-semibold shadow-xs">
            ...
            <div class="row g-4 align-items-start" id="cartActiveContainer">
                        ...
                        <div class="card-header bg-white border-bottom border-light-subtle py-3 px-4 d-flex align-items-center justify-content-between">
                            <div class="form-check fashion-checkbox-wrapper mb-0 d-flex align-items-center gap-2">
                                ...
                                <label class="form-check-label fw-semibold text-dark fs-7 cursor-pointer" for="select-all">
                                    Chọn tất cả (<span id="totalItemsCount"><?php echo e($items->count()); ?></span> món)
                                </label>
                            </div>
                            ...
                            <table class="table fashion-cart-table align-middle mb-0">
                                ...
                                <tbody id="cartTableBody">
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <tr data-item-id="<?php echo e($item->id); ?>" class="cart-item-row <?php echo e($isOutOfStock ? 'is-out-of-stock opacity-60' : ''); ?>">
                                            <!-- Checkbox -->
                                            <td class="ps-4">
                                            ...
                                            <!-- Thumbnail -->
                                            <td>
                                                <a href="<?php echo e(route('sanpham.chitiet', $item->sanPham->slug)); ?>" class="fashion-cart-thumb-link d-block position-relative">
                                                    <img src="<?php echo e(asset('storage/' . $item->sanPham->hinh_anh_chinh)); ?>"
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('sanpham.chitiet', $item->sanPham->slug)); ?>" class="fashion-cart-title text-decoration-none text-dark fw-bold d-block mb-1">
                                                    <?php echo e($item->sanPham->ten_san_pham); ?>
                                                ...
                                                <div class="fashion-variant-pill d-inline-flex align-items-center gap-1-5 px-2 py-1 rounded-pill bg-light border border-light-subtle small">
                                                    <?php if($item->bienThe): ?>
                                                        <?php if($item->bienThe->color): ?>
                                                            <span class="fashion-color-dot" style="background-color: <?php echo e($item->bienThe->color->ma_mau ?? '#cbd5e1'); ?>"></span>
                                                            <span class="text-dark fs-8"><?php echo e($item->bienThe->color->ten_mau); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($item->bienThe->color && $item->bienThe->size): ?>
                                                            <span class="text-muted">•</span>
                                                        <?php endif; ?>
                                                        <?php if($item->bienThe->size): ?>
                                                            <span class="fw-semibold text-dark fs-8">Size <?php echo e($item->bienThe->size->ten_kich_thuoc); ?></span>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <span class="text-muted fs-8">Tiêu chuẩn</span>
                                                    <?php endif; ?>
                                                </div>
                                                <?php if(!$isOutOfStock && $maxStock <= 5): ?>
                                                    <div class="text-warning-emphasis fs-8 mt-1">
                                                        <i class="bi bi-clock-history me-1"></i>Chỉ còn <?php echo e($maxStock); ?> sản phẩm
                                                    </div>
                                                <?php endif; ?>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span class="fw-semibold text-dark fs-7"><?php echo e(number_format($item->don_gia)); ?> ₫</span>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <div class="fashion-stepper d-inline-flex align-items-center justify-content-between rounded-pill border bg-white shadow-2xs"
                                                    data-item-id="<?php echo e($item->id); ?>" data-max="<?php echo e($maxStock); ?>">
                                                    <button type="button" class="fashion-stepper-btn btn-qty-minus rounded-circle"
                                                        <?php echo e($isOutOfStock || $displayQty <= 1 ? 'disabled' : ''); ?> aria-label="Giảm">
                                                        <i class="bi bi-dash"></i>
                                                    </button>
                                                    <input type="number" class="fashion-stepper-input text-center qty-input"
                                                        value="<?php echo e($displayQty); ?>" min="<?php echo e($isOutOfStock ? 0 : 1); ?>" max="<?php echo e($maxStock); ?>"
                                                        <?php echo e($isOutOfStock ? 'disabled' : ''); ?> readonly>
                                                    <button type="button" class="fashion-stepper-btn btn-qty-plus rounded-circle"
                                                        <?php echo e($isOutOfStock || $displayQty >= $maxStock ? 'disabled' : ''); ?> aria-label="Tăng">
                                            ...
                                            <!-- Subtotal -->
                                            <td class="text-end">
                                                <span class="fw-bold text-success fs-7 thanh-tien-cell" data-value="<?php echo e((int) $item->thanh_tien); ?>">
                                                    <?php echo e(number_format($item->thanh_tien)); ?> ₫
                                                </span>
                                            </td>
                                            ...
                                            <td class="text-center pe-4">
                                                <button type="button" class="btn btn-link text-muted p-2 fashion-btn-remove rounded-circle"
                                                    onclick="window.removeCartItem(<?php echo e($item->id); ?>)" title="Xóa món này">
                    ...
                    <div class="d-md-none" id="cartMobileCards">
                        ...
                        <div class="card border-0 shadow-xs rounded-4 bg-white p-3 mb-3">
                            <div class="form-check fashion-checkbox-wrapper mb-0 d-flex align-items-center justify-content-between">
                                ...
                                <span class="badge bg-light text-muted border rounded-pill fs-8">
                                    <span class="mobile-total-count"><?php echo e($items->count()); ?></span> món
                                </span>
                            </div>
                        </div>
                        ...
                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                ...
                                $isChecked = !$isOutOfStock && $useSelection && isset($selectedSet[$item->id]);
                            ?>
                            <div class="card border-0 shadow-xs rounded-4 bg-white p-3 mb-3 cart-item-mobile-card cart-item-row <?php echo e($isOutOfStock ? 'is-out-of-stock opacity-60' : ''); ?>"
                                data-item-id="<?php echo e($item->id); ?>">
                                <div class="d-flex gap-3">
                                    ...
                                    <div class="position-relative flex-shrink-0">
                                        <a href="<?php echo e(route('sanpham.chitiet', $item->sanPham->slug)); ?>">
                                            <img src="<?php echo e(asset('storage/' . $item->sanPham->hinh_anh_chinh)); ?>"
                                                alt="<?php echo e($item->sanPham->ten_san_pham); ?>"
                                    ...
                                    <div class="flex-grow-1 min-w-0">
                                        <div class="d-flex justify-content-between align-items-start gap-1">
                                            ...
                                            <button type="button" class="btn btn-link text-muted p-1 fashion-btn-remove"
                                                onclick="window.removeCartItem(<?php echo e($item->id); ?>)" title="Xóa món">
                                        ...
                                        <div class="fashion-variant-pill d-inline-flex align-items-center gap-1 px-2 py-0-5 rounded-pill bg-light border border-light-subtle small mb-2">
                                            <?php if($item->bienThe): ?>
                                                <?php if($item->bienThe->color): ?>
                                                    <span class="fashion-color-dot" style="background-color: <?php echo e($item->bienThe->color->ma_mau ?? '#cbd5e1'); ?>"></span>
                                                    <span class="text-dark fs-9"><?php echo e($item->bienThe->color->ten_mau); ?></span>
                                                <?php endif; ?>
                                                <?php if($item->bienThe->color && $item->bienThe->size): ?>
                                                    <span class="text-muted fs-9">•</span>
                                                <?php endif; ?>
                                                <?php if($item->bienThe->size): ?>
                                                    <span class="fw-semibold text-dark fs-9">Size <?php echo e($item->bienThe->size->ten_kich_thuoc); ?></span>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                ...
                <div class="col-lg-4">
                    <div class="fashion-order-summary-card card border-0 shadow-xs rounded-4 bg-white p-4 position-sticky" style="top: 80px;">
                        ...
                        <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-link text-muted text-decoration-none fs-8 text-center w-100 p-0 hover-underline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function syncSelectionToSession() {
        ...
        fetch('<?php echo e(route("gio-hang.selection")); ?>', {
            method: 'POST',
            headers: {
    ...
    document.getElementById('btn-proceed-to-checkout')?.addEventListener('click', function() {
        ...
        window.location.href = '<?php echo e(route("dat-hang")); ?>?' + queryString;
    });
});
</script><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views\client\gio-hang\index.blade.php ENDPATH**/ ?>