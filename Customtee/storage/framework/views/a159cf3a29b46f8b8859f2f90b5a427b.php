                                    ...
                                    <?php $__currentLoopData = $danhMucs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $danhMuc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <li>
                                            <a href="<?php echo e($categoryUrl); ?>"
                                               data-ajax-link="true"
                                               class="category-filter-item d-flex justify-content-between align-items-center py-2 px-2-5 rounded-3 text-decoration-none <?php echo e($isActiveCategory ? 'active' : ''); ?>">
                                                <span class="fs-7"><?php echo e($danhMuc->ten_danh_muc); ?></span>
                                                <i class="bi bi-chevron-right fs-8"></i>
                                            </a>
                                        </li>
