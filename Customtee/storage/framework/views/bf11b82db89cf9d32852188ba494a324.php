...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand text-success logo h1 align-self-center" href="<?php echo e(url('/')); ?>">
                FashionTee
            </a>
...
<a class="nav-link" href="<?php echo e(url('/')); ?>">Trang chủ</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/Shop')); ?>">Cửa hàng</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(url('/Contact')); ?>">Liên hệ</a>
                        </li>
                    </ul>
                </div>
...
<?php if(auth()->guard()->guest()): ?>
                        <a class="btn btn-outline-success me-2" href="<?php echo e(url('/login')); ?>">Đăng nhập</a>
                        <a class="btn btn-outline-primary me-2" href="<?php echo e(url('/register')); ?>">Đăng ký</a>
                    <?php else: ?>
                        <div class="dropdown">
...
</body><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/client/layout/header.blade.php ENDPATH**/ ?>