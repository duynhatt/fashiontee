    ...
    <div class="card-header bg-white border-bottom border-slate-100 py-3 px-4 d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-2">
            ...
            <h5 class="mb-0 fw-bold fs-15 text-slate-800">
                Sản phẩm trong đơn (<?php echo e($donHang->chiTietDonHangs->count()); ?>)
            </h5>
        </div>
        <span class="fs-13 text-slate-500">Tổng <?php echo e($donHang->chiTietDonHangs->sum('so_luong')); ?> món</span>
    </div>
                            ...
                            <td class="ps-4 py-3">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="position-relative flex-shrink-0">
                                        <img src="<?php echo e($chiTiet->sanPham->hinh_anh_chinh ? asset('storage/' . $chiTiet->sanPham->hinh_anh_chinh) : 'https://via.placeholder.com/64'); ?>"
                                            alt="<?php echo e($chiTiet->sanPham->ten_san_pham); ?>" class="rounded-3 border border-slate-200 product-thumb-img"
                                            width="64" height="64" style="object-fit: cover;">
                                    </div>
                                    <div class="product-info min-w-0">
                                        <a href="<?php echo e($chiTiet->sanPham ? route('sanpham.chitiet', $chiTiet->sanPham->slug) : '#'); ?>" class="fw-semibold text-slate-900 text-decoration-none hover-text-primary text-truncate-2 fs-14 mb-1 d-block">
                                            <?php echo e($chiTiet->sanPham->ten_san_pham); ?>
                                        ...
                                        <?php if($chiTiet->bienThe): ?>
                                            <div class="d-inline-flex align-items-center gap-1-5 px-2-5 py-0-5 rounded-pill bg-slate-100 text-slate-600 fs-12 border border-slate-200 mt-1">
                                                <?php if($chiTiet->bienThe->color): ?>
                                                    <span class="rounded-circle border border-slate-300 flex-shrink-0"
                                                        style="width: 10px; height: 10px; background-color: <?php echo e($chiTiet->bienThe->color->ma_mau ?? '#ccc'); ?>;"></span>
                                                    <span><?php echo e($chiTiet->bienThe->color->ten_mau ?? '—'); ?></span>
                                                <?php endif; ?>
                                                <?php if($chiTiet->bienThe->size): ?>
                                                    <span class="text-slate-400">/</span>
                                                    <span class="fw-medium"><?php echo e($chiTiet->bienThe->size->ten_kich_thuoc); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
...
<?php if($donHang->trang_thai === 'da_hoan_thanh'): ?>
                ...
                <?php $__currentLoopData = $donHang->chiTietDonHangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chiTiet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="p-3-5 rounded-4 border border-slate-200/80 bg-slate-50/50 review-item-box">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <div class="min-w-0">
                                <h6 class="fw-bold text-slate-900 fs-8 mb-1 text-truncate"><?php echo e($chiTiet->sanPham->ten_san_pham); ?></h6>
                                <?php if($chiTiet->bienThe): ?>
                                    <div class="fs-8 text-muted d-flex align-items-center gap-1-5">
                                        <?php if($chiTiet->bienThe->color): ?>
                                            <span class="rounded-circle border" style="width:10px;height:10px;background-color:<?php echo e($chiTiet->bienThe->color->ma_mau ?? '#ccc'); ?>;"></span>
                                            <span><?php echo e($chiTiet->bienThe->color->ten_mau ?? '—'); ?></span>
                                        <?php endif; ?>
                                        <?php if($chiTiet->bienThe->size): ?>
                                            <span class="text-slate-300">/</span>
                                            <span>Size <?php echo e($chiTiet->bienThe->size->ten_kich_thuoc); ?></span>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <?php else: ?>
                            <form action="<?php echo e(route('binh-luan.store')); ?>" method="POST" class="review-form"
                                data-product-id="<?php echo e($chiTiet->sanPham->id); ?>" data-variant-id="<?php echo e($chiTiet->bien_the_id); ?>" data-order-id="<?php echo e($donHang->id); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="san_pham_id" value="<?php echo e($chiTiet->sanPham->id); ?>">
                                <input type="hidden" name="bien_the_id" value="<?php echo e($chiTiet->bien_the_id); ?>">
                                <input type="hidden" name="don_hang_id" value="<?php echo e($donHang->id); ?>">
...
<?php endif; ?>
<?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views\client\Order\components\order-products.blade.php ENDPATH**/ ?>