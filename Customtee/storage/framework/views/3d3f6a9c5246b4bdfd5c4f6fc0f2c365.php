<?php $__env->startSection('AdminContent'); ?>
    ...
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="row mb-4 align-items-center">
            <div class="col-auto">
                <a href="<?php echo e(route('admin.don-hang.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="col">
                <h1 class="h3 mb-0 fw-bold text-dark">
                    Chi tiết đơn hàng
                    <span class="text-primary">#<?php echo e($donHang->ma_don_hang); ?></span>
                </h1>
                <p class="text-muted mb-0">
                    Đặt lúc <?php echo e($donHang->created_at->format('d/m/Y H:i')); ?>

                </p>
                <?php if(!empty($donHang->da_giao_at)): ?>
                    <p class="text-muted mb-0">
                        Đã giao lúc <?php echo e($donHang->da_giao_at->format('d/m/Y H:i')); ?>

                    </p>
                <?php endif; ?>
            </div>
            <div class="col-auto text-end">
                <span class="badge bg-<?php echo e($badge); ?> fs-5 px-4 py-2">
                    <?php echo e($tenTrangThaiHienTai); ?>

                </span>
                <?php if($isPendingCancelRequest): ?>
                    <span class="badge bg-warning text-dark fs-6 px-3 py-2 mt-2 d-inline-block">
                        <i class="fas fa-hourglass-half me-1"></i> Yêu cầu hủy
                    </span>
                <?php endif; ?>
                <?php if($donHang->yeu_cau_tra): ?>
                    <span class="badge bg-danger fs-6 px-3 py-2 mt-2 d-inline-block">
                        <i class="fas fa-undo-alt me-1"></i> <?php echo e($refundRequestLabel); ?>
                        ...
                        <div class="row g-4">
                                ...
                                <div class="bg-light rounded-3 p-3">
                                    <table class="table table-borderless table-sm mb-0">
                                        <tr>
                                            ...
                                            <td class="fw-medium"><?php echo e($donHang->ten_nguoi_nhan); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">Số điện thoại:</td>
                                            <td class="fw-medium"><?php echo e($donHang->so_dien_thoai_nhan_hang); ?></td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted align-top">Địa chỉ:</td>
                                            <td class="fw-medium"><?php echo e($donHang->dia_chi_chi_tiet); ?></td>
                                        </tr>
                                        <?php if($donHang->nguoiDung): ?>
                                            <tr>
                                                <td class="text-muted">Tài khoản:</td>
                                                <td><?php echo e($donHang->nguoiDung->name ?? $donHang->nguoiDung->email); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="bg-light rounded-3 p-3">
                                    <table class="table table-borderless table-sm mb-0">
                                        <tr>
                                            ...
                                            <td class="text-end"><?php echo e(number_format($donHang->tam_tinh, 0, ',', '.')); ?> ₫
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">Giảm giá:</td>
                                            <td class="text-end text-danger">
                                                -<?php echo e(number_format($donHang->tien_giam ?? 0, 0, ',', '.')); ?> ₫</td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">Phí vận chuyển:</td>
                                            <td class="text-end">
                                                <?php echo e(number_format($donHang->phi_van_chuyen ?? 0, 0, ',', '.')); ?> ₫</td>
                                        </tr>
                                        <tr class="border-top">
                                            <td class="fw-bold">Tổng thanh toán:</td>
                                            <td class="text-end fw-bold text-primary fs-5">
                                                <?php echo e(number_format($donHang->tong_tien, 0, ',', '.')); ?> ₫
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="mt-3 small">
                                    ...
                                    <?php if($donHang->trang_thai_thanh_toan === 'da_thanh_toan' || $donHang->trang_thai === 'da_hoan_thanh'): ?>
            ...
            <div class="col-lg-7">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary"><?php echo e(count($donHang->chiTietDonHangs)); ?> sản phẩm</span>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0 align-middle">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $donHang->chiTietDonHangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-center text-muted"><?php echo e($i + 1); ?></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <?php if($ct->sanPham->hinh_anh_chinh ?? null): ?>
                                                        <img src="<?php echo e(asset('storage/' . $ct->sanPham->hinh_anh_chinh)); ?>"
                                                            alt="" width="45" height="45"
                                                            class="rounded me-3 object-fit-cover">
                                                    <?php endif; ?>
                                                    <div>
                                                        <div class="fw-medium"><?php echo e($ct->sanPham->ten_san_pham); ?></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="small text-muted">
                                                <?php if($ct->bienThe): ?>
                                                    <?php echo e($ct->bienThe->color->ten_mau ?? '—'); ?> /
                                                    <?php echo e($ct->bienThe->size->ten_kich_thuoc ?? '—'); ?>

                                                <?php else: ?>
                                                    —
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center fw-medium"><?php echo e($ct->so_luong); ?></td>
                                            <td class="text-end"><?php echo e(number_format($ct->don_gia, 0, ',', '.')); ?> ₫</td>
                                            <td class="text-end fw-bold text-primary">
                                                <?php echo e(number_format($ct->thanh_tien, 0, ',', '.')); ?> ₫
                                            </td>
                                        </tr>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="text-muted">
                                        ...
                                        <span
                                            ...
                                            <?php echo e($appliedVoucherCode); ?>

                                        </span>
                                    </span>
                                    <?php if(($donHang->tien_giam ?? 0) > 0): ?>
                                        <span class="text-danger fw-semibold">
                                            -<?php echo e(number_format($donHang->tien_giam, 0, ',', '.')); ?> ₫
                                        </span>
                                    <?php else: ?>
                        ...
                        <?php if($isPendingCancelRequest): ?>
                            <div class="p-4 border-top">
                                <?php if($donHang->ly_do_yeu_cau_huy): ?>
                                    <div class="alert alert-info small mb-3">
                                        <strong>Lý do khách hủy:</strong> <?php echo e($donHang->ly_do_yeu_cau_huy); ?>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <form action="<?php echo e(route('admin.don-hang.cancel-request.approve', $donHang)); ?>"
                                            method="post"
                                    ...
                                    <div class="col-md-6">
                                        <button type="button" class="btn btn-outline-danger btn-lg w-100"
                                            ...
                                            aria-expanded="<?php echo e($errors->has('ly_do_tu_choi_huy') ? 'true' : 'false'); ?>"
                                ...
                                <div class="collapse mt-3 <?php echo e($errors->has('ly_do_tu_choi_huy') ? 'show' : ''); ?>"
                                    id="rejectCancelForm">
                                    <div class="card card-body border-danger-subtle">
                                        <form action="<?php echo e(route('admin.don-hang.cancel-request.reject', $donHang)); ?>"
                                            method="post"
                                            class="js-confirm-submit"
                                            ...
                                            <textarea name="ly_do_tu_choi_huy" class="form-control mb-2" rows="3" required
                                                placeholder="Nhập lý do từ chối..."><?php echo e(old('ly_do_tu_choi_huy')); ?></textarea>
                                            <?php $__errorArgs = ['ly_do_tu_choi_huy'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if($customerNote || $donHang->yeu_cau_tra): ?>
                <div class="col-12">
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <?php if($customerNote): ?>
                            ...
                            <?php if($donHang->yeu_cau_tra): ?>
                                <div>
                                    <h6 class="fw-semibold text-danger mb-2">
                                        <i class="fas fa-undo-alt me-2"></i> <?php echo e($refundRequestLabel); ?> từ khách
                                    </h6>
                                    <div class="alert alert-danger border-0">
                                        <strong>Thời gian:</strong>
                                        <?php echo e($returnRequestedAt?->format('d/m/Y H:i') ?? 'Chưa có dữ liệu'); ?><br>
                                        <strong>Lý do:</strong> <?php echo e($returnReason ?: 'Không có lý do cụ thể'); ?>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <?php elseif($isRefundFlowLocked): ?>
                            <div class="alert alert-warning text-center py-4 mb-0">
                                <i class="fas fa-lock me-2"></i>
                                Không thể chuyển trạng thái đơn hàng.
                            </div>
                        <?php elseif(count($trangThaiTiepTheo) > 0): ?>
                            <form action="<?php echo e(route('admin.don-hang.update-status', $donHang)); ?>" method="post"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <select name="trang_thai" id="trangThaiSelect" class="form-select form-select-lg" required>
                                        <?php $__currentLoopData = $trangThaiTiepTheo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-12 d-none" id="lyDoHuyAdminWrapper">
                                    ...
                                    <textarea name="ly_do_huy_boi_admin" class="form-control" rows="3"
                                        placeholder="Nhập lý do hủy để khách hàng nắm được..."><?php echo e(old('ly_do_huy_boi_admin')); ?></textarea>
                                    <?php $__errorArgs = ['ly_do_huy_boi_admin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.layout.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/admin/don-hang/show.blade.php ENDPATH**/ ?>