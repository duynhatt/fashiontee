...
<head>
    ...
    <title>Xác thực tài khoản FashionTee</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 35px 40px 30px 40px;">
                            <h2 style="margin: 0 0 16px 0; font-size: 20px; font-weight: 700; color: #0f172a;">
                                Xin chào <?php echo e($name); ?>,
                            </h2>
                            <p style="margin: 0 0 16px 0; font-size: 15px; line-height: 1.6; color: #475569;">
                                Cảm ơn bạn đã đăng ký tài khoản tại <strong>FashionTee</strong>. Để kích hoạt tài khoản và bảo vệ thông tin của bạn, vui lòng nhập mã xác thực OTP gồm 6 chữ số dưới đây:
                            </p>

                            <!-- OTP Box -->
                            <div style="background-color: #f0fdf4; border: 2px dashed #10b981; border-radius: 10px; padding: 20px; text-align: center; margin: 25px 0;">
                                <div style="font-size: 13px; font-weight: 600; color: #059669; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">
                            ...
                            <p style="margin: 0 0 12px 0; font-size: 14px; line-height: 1.6; color: #64748b;">
                                🔒 <strong>Lưu ý bảo mật:</strong> Không chia sẻ mã OTP này cho bất kỳ ai, kể cả nhân viên hỗ trợ của FashionTee.
                            </p>
                            <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #64748b;">
                                Nếu bạn không thực hiện yêu cầu đăng ký này, vui lòng bỏ qua email này hoặc liên hệ ngay với chúng tôi để được hỗ trợ.
                            </p>
...
<?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/emails/verify-code.blade.php ENDPATH**/ ?>