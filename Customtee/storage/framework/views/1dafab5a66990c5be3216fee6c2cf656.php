            ...
            <form action="<?php echo e(route('admin.roles.store')); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="VD: content_editor, accountant" required>
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" name="display_name" class="form-control" value="<?php echo e(old('display_name')); ?>" placeholder="VD: Quản lý Nội dung, Kế toán..." required>
                    </div>
                </div>

                <div class="form-group">
                    <label><strong>Mô tả vai trò</strong></label>
                    <textarea name="description" class="form-control" rows="2" placeholder="Mô tả tóm tắt nhiệm vụ của vai trò này..."><?php echo e(old('description')); ?></textarea>
                </div>
                                    ...
                                    <?php $__currentLoopData = $perms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="checkbox" style="margin-top: 6px; margin-bottom: 6px;">
                                            <label style="cursor: pointer;">
                                                <input type="checkbox" name="permissions[]" value="<?php echo e($perm->id); ?>" class="perm-checkbox group-<?php echo e($group); ?>" <?php echo e(in_array($perm->id, old('permissions', [])) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layout.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/admin/roles/create.blade.php ENDPATH**/ ?>