...
<div class="fashion-orders-page bg-light-subtle py-4 py-md-5">
    <div class="container-xl px-3 px-lg-4">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
            <div>
                <h1 class="h3 fw-bold text-dark mb-1 tracking-tight">
                    Đơn hàng của tôi
                    <?php if(isset($donHangs) && $donHangs->total() > 0): ?>
                        <span class="text-muted fw-normal fs-6">(<?php echo e($donHangs->total()); ?> đơn)</span>
                    <?php endif; ?>
                </h1>
               
            </div>
            <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-sm btn-outline-dark rounded-pill px-3 py-1-5 fw-semibold d-inline-flex align-items-center gap-1">
        ...
        <div class="card border-0 shadow-xs rounded-4 bg-white p-3 mb-4">
            <!-- Search Input -->
            <form action="<?php echo e(route('order')); ?>" method="GET" class="mb-3">
                <?php if($currentStatus): ?>
                    <input type="hidden" name="trang_thai" value="<?php echo e($currentStatus); ?>">
                <?php endif; ?>
                <div class="input-group fashion-order-search-group">
                    <span class="input-group-text bg-light border-0 ps-3 text-muted">
                        <i class="bi bi-search"></i>
                    </span>
                    <input type="text" name="q" value="<?php echo e($currentSearch); ?>"
                    ...
                    <?php if(!empty($currentSearch)): ?>
                        <a href="<?php echo e(route('order', array_filter(['trang_thai' => $currentStatus]))); ?>"
            ...
            <div class="fashion-order-tabs-scroll-wrap">
                <ul class="nav fashion-order-nav-pills gap-2 flex-nowrap flex-md-wrap mb-0">
                    <li class="nav-item">
                        <a class="nav-link fashion-order-pill <?php echo e(empty($currentStatus) ? 'active' : ''); ?>"
                            href="<?php echo e(route('order', array_filter(['q' => $currentSearch]))); ?>">
                            Tất cả đơn
                        </a>
                    </li>
                    <?php $__currentLoopData = $statusTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item">
                            <a class="nav-link fashion-order-pill <?php echo e($currentStatus === $key ? 'active' : ''); ?>"
                                href="<?php echo e(route('order', array_filter(['trang_thai' => $key, 'q' => $currentSearch]))); ?>">
                                <?php echo e($label); ?>
            ...
            <div class="card border-0 shadow-xs rounded-4 text-center py-5 my-3 bg-white">
                <div class="card-body py-5 px-3">
                    ...
                    <?php if(!empty($currentSearch) || !empty($currentStatus)): ?>
                        ...
                        <a href="<?php echo e(route('order')); ?>" class="btn btn-outline-dark rounded-pill px-4 py-2 fw-semibold fs-8">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-dark rounded-pill px-4 py-2 fw-semibold fs-8 shadow-xs">
                    ...
                    <div class="card fashion-order-card border-0 shadow-2xs rounded-4 bg-white overflow-hidden">
                        ...
                        <div class="card-header bg-white border-bottom border-light-subtle py-3 px-3 px-sm-4 d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div class="d-flex align-items-center flex-wrap gap-2 gap-sm-3">
                                <span class="fw-bold text-dark fs-7 tracking-tight">
                                    Đơn hàng: <span class="text-primary font-monospace">#<?php echo e($donHang->ma_don_hang); ?></span>
                                </span>
                                <span class="text-muted fs-8">
                                    <i class="bi bi-calendar3 me-1"></i><?php echo e($donHang->created_at->format('d/m/Y - H:i')); ?>

                                </span>
                                <?php if($showReturnCountdown): ?>
                                    <span class="badge bg-danger-subtle text-danger border border-danger-subtle rounded-pill fs-9 py-1 px-2 js-return-countdown"
                                        data-deadline-ts="<?php echo e($returnDeadlineTs); ?>">
                            ...
                            <!-- Status Badge -->
                            <div>
                                <?php if($donHang->trang_thai !== 'da_hoan_thanh' && $latestRefund && $latestRefund->trang_thai === 'da_tu_choi'): ?>
                                ...
                                <?php elseif($donHang->yeu_cau_tra): ?>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-<?php echo e($st[1]); ?>-subtle text-<?php echo e($st[1]); ?> border border-<?php echo e($st[1]); ?>-subtle rounded-pill px-3 py-1-5 fs-8 d-inline-flex align-items-center gap-1">
                                        <i class="<?php echo e($st[2]); ?>"></i> <?php echo e($st[0]); ?>
                        ...
                        <div class="card-body p-3 px-sm-4">
                            ...
                            <div class="d-flex flex-column gap-2-5">
                                <?php $__currentLoopData = $visibleItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="fashion-order-item-row d-flex align-items-center gap-3 p-2 rounded-3 bg-light-subtle">
                                        <a href="<?php echo e($ct->sanPham ? route('sanpham.chitiet', $ct->sanPham->slug) : '#'); ?>" class="flex-shrink-0">
                                            <img src="<?php echo e($ct->sanPham && $ct->sanPham->hinh_anh_chinh ? asset('storage/' . $ct->sanPham->hinh_anh_chinh) : asset('img/default-avatar.png')); ?>"
                                                alt="<?php echo e($ct->sanPham->ten_san_pham ?? 'Sản phẩm'); ?>"
                                                class="fashion-order-item-thumb rounded-3">
                                        </a>

                                        <div class="flex-grow-1 min-w-0">
                                            <a href="<?php echo e($ct->sanPham ? route('sanpham.chitiet', $ct->sanPham->slug) : '#'); ?>"
                                                class="text-decoration-none text-dark fw-bold fs-7 text-truncate d-block mb-1 hover-primary">
                                                <?php echo e($ct->sanPham->ten_san_pham ?? 'Sản phẩm không khả dụng'); ?>

                                            </a>
                                            <div class="d-flex align-items-center gap-1-5 flex-wrap fs-8 text-muted mb-1">
                                                <?php if($ct->bienThe && $ct->bienThe->color): ?>
                                                    <span class="fashion-color-dot" style="background-color: <?php echo e($ct->bienThe->color->ma_mau ?? '#ccc'); ?>"></span>
                                                    <span><?php echo e($ct->bienThe->color->ten_mau); ?></span>
                                                <?php endif; ?>
                                                <?php if($ct->bienThe && $ct->bienThe->color && $ct->bienThe->size): ?>
                                                    <span>•</span>
                                                <?php endif; ?>
                                                <?php if($ct->bienThe && $ct->bienThe->size): ?>
                                                    <span class="badge bg-light text-dark border px-1-5 py-0-5 fs-9">Size <?php echo e($ct->bienThe->size->ten_kich_thuoc); ?></span>
                                                <?php endif; ?>
                                                <span class="badge bg-light text-muted border px-1-5 py-0-5 fs-9">x<?php echo e($ct->so_luong); ?></span>
                                            </div>
                                        </div>

                                        <div class="text-end flex-shrink-0">
                                            <div class="fw-bold text-dark fs-7"><?php echo e(number_format($ct->thanh_tien)); ?> ₫</div>
                                            <div class="text-muted fs-9"><?php echo e(number_format($ct->don_gia)); ?> ₫/cái</div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <?php if($hiddenItems->isNotEmpty()): ?>
                                    <div class="collapse" id="collapseItems-<?php echo e($donHang->id); ?>">
                                        <div class="d-flex flex-column gap-2-5 pt-2">
                                            <?php $__currentLoopData = $hiddenItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="fashion-order-item-row d-flex align-items-center gap-3 p-2 rounded-3 bg-light-subtle">
                                                    <a href="<?php echo e($ct->sanPham ? route('sanpham.chitiet', $ct->sanPham->slug) : '#'); ?>" class="flex-shrink-0">
                                                        <img src="<?php echo e($ct->sanPham && $ct->sanPham->hinh_anh_chinh ? asset('storage/' . $ct->sanPham->hinh_anh_chinh) : asset('img/default-avatar.png')); ?>"
                                                            alt="<?php echo e($ct->sanPham->ten_san_pham ?? 'Sản phẩm'); ?>"
                                                    ...
                                                    <div class="flex-grow-1 min-w-0">
                                                        <a href="<?php echo e($ct->sanPham ? route('sanpham.chitiet', $ct->sanPham->slug) : '#'); ?>"
                                                            class="text-decoration-none text-dark fw-bold fs-7 text-truncate d-block mb-1 hover-primary">
                                                            <?php echo e($ct->sanPham->ten_san_pham ?? 'Sản phẩm'); ?>
                                    ...
                                    <button class="btn btn-link text-muted fs-8 text-decoration-none p-0 align-self-center mt-1"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapseItems-<?php echo e($donHang->id); ?>"
                                        aria-expanded="false" aria-controls="collapseItems-<?php echo e($donHang->id); ?>"
                                        onclick="this.querySelector('.toggle-text').textContent = this.getAttribute('aria-expanded') === 'true' ? 'Thu gọn' : 'Xem thêm <?php echo e($hiddenItems->count()); ?> sản phẩm khác'">
                                        <span class="toggle-text">Xem thêm <?php echo e($hiddenItems->count()); ?> sản phẩm khác</span>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    <div class="d-flex align-items-center gap-2 fs-8 text-muted">
                                        <span>
                                            ...
                                            <?php echo e($donHang->phuong_thuc_thanh_toan === 'cod' ? 'Thanh toán khi nhận hàng (COD)' : 'Thanh toán trực tuyến VNPay'); ?>

                                        </span>
                                        <?php if($donHang->trang_thai_thanh_toan === 'da_thanh_toan' || $donHang->trang_thai === 'da_hoan_thanh' || ($donHang->phuong_thuc_thanh_toan === 'cod' && $donHang->trang_thai === 'da_giao')): ?>
                                    ...
                                    <div class="d-flex align-items-baseline gap-2">
                                        ...
                                        <span class="fs-5 fw-extrabold text-success tracking-tight">
                                            <?php echo e(number_format($donHang->tong_tien)); ?> ₫
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2 justify-content-start justify-content-md-end">
                                    ...
                                    <?php if($canCancel): ?>
                                        <button type="button" class="btn btn-outline-danger rounded-pill px-3 py-1-5 fs-8 fw-semibold d-inline-flex align-items-center gap-1"
                                            onclick="openCancelOrderModal(<?php echo e($donHang->id); ?>, '<?php echo e($donHang->ma_don_hang); ?>', '<?php echo e($donHang->trang_thai); ?>', '<?php echo e($donHang->phuong_thuc_thanh_toan); ?>', '<?php echo e($donHang->trang_thai_thanh_toan); ?>')">
                                            <i class="bi bi-x-circle"></i>
                                            <?php echo e($donHang->trang_thai === 'dang_xu_ly' ? 'Yêu cầu hủy' : 'Hủy đơn hàng'); ?>

                                        </button>
                                    <?php endif; ?>

                                    <!-- Nút Thanh toán lại VNPay -->
                                    <?php if($donHang->phuong_thuc_thanh_toan === 'vnpay' && in_array($donHang->trang_thai_thanh_toan, ['chua_thanh_toan', 'that_bai'], true) && $donHang->trang_thai !== 'da_huy'): ?>
                                        <a href="<?php echo e(route('order.repay', $donHang->id)); ?>" class="btn btn-danger rounded-pill px-3 py-1-5 fs-8 fw-semibold d-inline-flex align-items-center gap-1">
                                            <i class="bi bi-credit-card"></i> Thanh toán lại
                                        </a>
                                    <?php endif; ?>

                                    <!-- Nút Xác nhận nhận hàng -->
                                    <?php if($donHang->trang_thai === 'da_giao' && !$donHang->yeu_cau_tra && empty($donHang->da_nhan_hang_at)): ?>
                                        <form action="<?php echo e(route('order.received', $donHang->id)); ?>" method="POST" class="d-inline js-client-confirm-submit"
                                    ...
                                    <?php if($donHang->trang_thai === 'da_giao' && !$donHang->yeu_cau_tra && !empty($donHang->da_nhan_hang_at)): ?>
                                        <?php
                                            $confirmDeadlineTs = !empty($donHang->da_giao_at)
                                                ...
                                                : null;
                                        ?>
                                        <form action="<?php echo e(route('order.confirm', $donHang->id)); ?>" method="POST" class="d-inline js-client-confirm-submit"
                                            data-return-deadline-ts="<?php echo e($confirmDeadlineTs); ?>" data-confirm-message="Xác nhận hoàn thành đơn hàng này?" data-confirm-action="complete">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <?php if($canReorder): ?>
                                        <button type="button" class="btn btn-dark rounded-pill px-3 py-1-5 fs-8 fw-semibold d-inline-flex align-items-center gap-1"
                                            onclick="reorderItems(<?php echo e($donHang->id); ?>, this)">
                                            <i class="bi bi-arrow-repeat"></i> Mua lại
                                        </button>
                                    <?php endif; ?>

                                    <!-- Nút Xem chi tiết -->
                                    <a href="<?php echo e(route('order.show', $donHang->id)); ?>" class="btn btn-outline-dark rounded-pill px-3 py-1-5 fs-8 fw-semibold d-inline-flex align-items-center gap-1">
                                        <span>Chi tiết</span>
...
</script><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views\client\Order\index.blade.php ENDPATH**/ ?>