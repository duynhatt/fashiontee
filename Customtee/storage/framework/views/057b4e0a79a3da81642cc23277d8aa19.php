    ...
    <div class="row justify-content-center">
        <div class="col-12 col-xxl-11">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 mb-md-5 gap-3">
                ...
                <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-primary btn-lg px-4 rounded-pill shadow-sm">
            ...
            <?php if($donHangs->isEmpty() && !$currentStatus): ?>
                <div class="card border-0 shadow-lg rounded-4 text-center py-5 px-4 bg-gradient-light">
                    <div class="card-body">
                        ...
                        <p class="text-muted fs-5 mb-4">Hãy khám phá ngay hàng ngàn sản phẩm chất lượng với nhiều ưu đãi
                            hấp dẫn!</p>
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-primary btn-lg px-5 py-3 rounded-pill shadow">
            ...
            <?php else: ?>
                ...
                <ul class="nav nav-pills mb-4 shadow-sm rounded-pill bg-white p-2 order-status-tabs">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link rounded-pill px-4 py-2 <?php echo e(!$currentStatus ? 'active' : ''); ?>"
                            href="<?php echo e(route('order')); ?>">
                            Tất cả
                        </a>
                    </li>

                    <?php $__currentLoopData = $statusTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item" role="presentation"><a
                                class="nav-link rounded-pill px-4 py-2 <?php echo e($currentStatus === $key ? 'active' : ''); ?>"
                                href="<?php echo e(route('order', ['trang_thai' => $key])); ?>">
                                <?php echo e($value[0]); ?>
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <h5 class="mb-0 fw-bold text-dark">
                                                Mã đơn: <span class="text-primary"><?php echo e($donHang->ma_don_hang); ?></span>
                                            </h5>
                                        ...
                                        <div class="d-flex flex-column align-items-end gap-2">
                                            <div class="d-flex flex-wrap justify-content-end gap-2">
                                                <?php if($donHang->trang_thai === 'da_giao' && !$donHang->yeu_cau_tra && empty($donHang->da_nhan_hang_at)): ?>
                                                    <form action="<?php echo e(route('order.received', $donHang->id)); ?>"
                                                        method="post"
                                                ...
                                                <?php elseif($donHang->trang_thai === 'da_giao' && !$donHang->yeu_cau_tra && !empty($donHang->da_nhan_hang_at)): ?>
                                                    <?php
                                                        $confirmDeadlineTs = !empty($donHang->da_giao_at)
                                                            ? $donHang->da_giao_at->copy()->addDays(3)->getTimestampMs()
                                                            : null;
                                                    ?>
                                                    <form action="<?php echo e(route('order.confirm', $donHang->id)); ?>"
                                                        method="post"
                                                        class="js-client-confirm-submit"
                                                        data-return-deadline-ts="<?php echo e($confirmDeadlineTs); ?>"
                                                ...
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('order.show', $donHang->id)); ?>"
                                        ...
                                        <div class="row g-4 align-items-center mb-4">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h6 class="fw-bold mb-1">
                                                            <?php echo e($donHang->chiTietDonHangs->count()); ?> sản
                                                            phẩm</h6>
                                            ...
                                            <div class="col-md-4 text-md-center">
                                                <h5 class="fw-bold text-dark mb-1">
                                                    <?php echo e(number_format($donHang->tong_tien, 0, ',', '.')); ?> ₫</h5>
                                            ...
                                            <div class="col-md-4 d-flex justify-content-md-end">
                                                ...
                                                <?php else: ?>
                                                    <span
                                                        class="badge bg-<?php echo e($st[1]); ?>-subtle text-<?php echo e($st[1]); ?> border border-<?php echo e($st[1]); ?> fs-6 px-4 py-2 d-flex align-items-center rounded-pill">
                                                        <i class="<?php echo e($st[2]); ?> me-2 fs-5"></i>
                                                        <?php echo e($st[0]); ?>
                                                ...
                                                <?php $__currentLoopData = $donHang->chiTietDonHangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-12">
                                                        <div
                                                            ...
                                                            <?php if($ct->sanPham->hinh_anh_chinh ?? false): ?>
                                                                <img src="<?php echo e(asset('storage/' . $ct->sanPham->hinh_anh_chinh)); ?>"
                                                                    alt="<?php echo e($ct->sanPham->ten_san_pham); ?>"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-flex flex-wrap gap-3 mb-2 small">
                                                                    <?php if($ct->bienThe && $ct->bienThe->color): ?>
                                                                        <div class="d-flex align-items-center gap-2">
                                                                            <div class="rounded-circle border shadow-sm"
                                                                                style="width: 18px; height: 18px; background-color: <?php echo e($ct->bienThe->color->ma_mau ?? '#ccc'); ?>; border: 1px solid #dee2e6;">
                                                                            </div>
                                                                            <span><?php echo e($ct->bienThe->color->ten_mau ?? 'Không có màu'); ?></span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    ...
                                                                    <div>
                                                                        <span
                                                                            class="badge bg-primary-subtle text-primary border">x<?php echo e($ct->so_luong); ?>
                                                                ...
                                                                <div class="fw-medium text-dark">
                                                                    ...
                                                                    <small class="text-muted ms-2">
                                                                        (<?php echo e(number_format($ct->don_gia, 0, ',', '.')); ?>

                                                                        ₫ × <?php echo e($ct->so_luong); ?>)
                                                                    </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="card-footer bg-light border-0 px-4 py-3">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                            <small class="text-muted">
                                                ...
                                                <?php echo e($donHang->phuong_thuc_thanh_toan === 'cod' ? 'Thanh toán khi nhận hàng' : ucfirst(str_replace('_', ' ', $donHang->phuong_thuc_thanh_toan))); ?>
...
<?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/client/order/index.blade.php ENDPATH**/ ?>