    ...
    <div class="container-fluid px-0">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                ...
                <div class="text-muted small">
                    Tổng cộng: <strong class="text-primary"><?php echo e($refunds->total()); ?></strong> yêu cầu
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4 rounded-3">
            <div class="card-body pb-2">
                <form method="GET" action="<?php echo e(route('admin.hoan-tra.index')); ?>" class="row g-3 align-items-end">
                    <div class="col-md-4 col-lg-3">
                        <select name="trang_thai" class="form-select form-select-sm border-primary focus-ring-primary">
                            <option value="">Tất cả trạng thái</option>
                            <option value="cho_xu_ly" <?php echo e(request('trang_thai') == 'cho_xu_ly' ? 'selected' : ''); ?>>Chờ xử lý
                            </option>
                            <option value="da_chap_nhan" <?php echo e(request('trang_thai') == 'da_chap_nhan' ? 'selected' : ''); ?>>Đã
                                chấp nhận</option>
                            <option value="da_tu_choi" <?php echo e(request('trang_thai') == 'da_tu_choi' ? 'selected' : ''); ?>>Đã từ
                                chối</option>
                            <option value="da_hoan_tien" <?php echo e(request('trang_thai') == 'da_hoan_tien' ? 'selected' : ''); ?>>Đã
                                hoàn tiền</option>
                        </select>
                    </div>
                        ...
                        <tbody class="border-top-0">
                            <?php $__empty_1 = true; $__currentLoopData = $refunds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover-bg-light">
                                    <td class="ps-4 fw-medium"><?php echo e($refund->id); ?></td>
                                    <td>
                                        <a href="<?php echo e(route('admin.don-hang.show', $refund->donHang->id ?? null)); ?>"
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                <span class="fw-medium">
                                                    <?php echo e($refund->donHang->ten_nguoi_nhan ?? 'Khách vãng lai'); ?>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <span
                                            class="badge rounded-pill px-3 py-2 fs-6 fw-medium <?php echo e($statusClasses[$refund->trang_thai] ?? 'bg-secondary'); ?>">
                                            <?php echo e($refund->trang_thai_text ?? ucfirst(str_replace('_', ' ', $refund->trang_thai))); ?>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('admin.hoan-tra.show', $refund->id)); ?>"
            ...
            <?php if($refunds->hasPages()): ?>
                <div class="card-footer bg-white border-0 pt-0">
                    <div class="d-flex justify-content-center">
                        <?php echo e($refunds->appends(request()->query())->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('admin.layout.AdminLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views\admin\hoan-tra\index.blade.php ENDPATH**/ ?>