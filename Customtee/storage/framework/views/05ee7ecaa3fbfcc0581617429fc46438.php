        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Tất cả sản phẩm</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Áo thun</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Áo khoác</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Quần</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Phụ kiện</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-4 pt-5">
                    ...
                    <ul class="list-unstyled text-light footer-link-list">
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/')); ?>">Trang chủ</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Shop')); ?>">Cửa hàng</a></li>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(url('/Contact')); ?>">Liên hệ</a></li>
                        <?php if(auth()->guard()->check()): ?>
                        <li><a class="text-decoration-none text-light" href="<?php echo e(route('order')); ?>">Đơn hàng của tôi</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light mb-0">
                            &copy; <?php echo e(date('Y')); ?> <strong>fashionTee</strong>. Bản quyền thuộc fashionTee.
                        </p>
                    </div>
                </div>
            </div>
