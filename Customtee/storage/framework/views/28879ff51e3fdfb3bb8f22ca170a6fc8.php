...
<div class="container my-5">
    <nav aria-label="breadcrumb" class="my-4">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(url('/')); ?>" class="text-decoration-none">Trang chủ</a></li>
    ...
    <div class="card border-0 shadow-sm rounded-4">
        <div class="card-body text-center py-5">
            ...
            <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-success">Tiếp tục mua sắm</a>
        </div>
    </div>
    <?php else: ?>
            ...
            <tbody>
                ...
                $isOutOfStock = $maxStock < 1;
                    ...
                    <tr data-item-id="<?php echo e($item->id); ?>">
                        ...
                        <td>
                            <a href="<?php echo e(route('sanpham.chitiet', $item->sanPham->slug)); ?>" class="text-decoration-none text-dark fw-semibold">
                        ...
                        <td>
                            <?php if($item->bienThe): ?>
                            <span class="badge bg-secondary"><?php echo e($item->bienThe->color->ten_mau ?? '—'); ?> / <?php echo e($item->bienThe->size->ten_kich_thuoc ?? '—'); ?></span>
                            <?php if($isOutOfStock): ?>
                        ...
                        <td class="text-end"><?php echo e(number_format($item->don_gia)); ?> ₫</td>
                        <td>
                            <form action="<?php echo e(route('gio-hang.update', $item)); ?>" method="POST" class="d-inline-flex align-items-center justify-content-center gap-1 form-update-qty" data-item-id="<?php echo e($item->id); ?>" data-max="<?php echo e($maxStock); ?>">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="_method" value="PUT">
                                <div class="input-group input-group-sm" style="width: 120px;">
                                    <button type="button" class="btn btn-outline-secondary btn-qty-minus" <?php echo e($isOutOfStock ? 'disabled' : ''); ?>>−</button>
                                    <input type="number" name="so_luong" class="form-control text-center qty-input" min="<?php echo e($isOutOfStock ? 0 : 1); ?>" value="<?php echo e($displayQty); ?>" max="<?php echo e($maxStock); ?>" <?php echo e($isOutOfStock ? 'disabled' : ''); ?>>
                                    <button type="button" class="btn btn-outline-secondary btn-qty-plus" <?php echo e($isOutOfStock ? 'disabled' : ''); ?>>+</button>
                                </div>
                            </form>
                        </td>
                        <td class="text-end fw-bold text-danger thanh-tien-cell"><?php echo e(number_format($item->thanh_tien)); ?> ₫</td>
                        <td>
                            <form action="<?php echo e(route('gio-hang.destroy', $item)); ?>" method="POST" class="d-inline form-remove-item">
                                <?php echo csrf_field(); ?>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        <span>Tạm tính:</span>
                        <strong class="text-danger" id="tong-tien"><?php echo e(number_format($tongTien)); ?> ₫</strong>
                    </div>
    ...
    <div class="mt-4 d-flex gap-2 justify-content-between flex-wrap">
        <a href="<?php echo e(url('/Shop')); ?>" class="btn btn-outline-secondary">Tiếp tục mua sắm</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        updateQtyForms.forEach(function(form) {
            ...
            form.addEventListener('submit', function(e) {
                ...
                const url = '<?php echo e(url("/gio-hang")); ?>/' + itemId;
                fetch(url, {
                        method: 'PUT',
                        headers: {
                            'Content-Type': 'application/json',
...
<?php endif; ?><?php /**PATH D:\e7\laragon\www\DATN\DATN-CustomTee\Customtee\resources\views/client/gio-hang/index.blade.php ENDPATH**/ ?>