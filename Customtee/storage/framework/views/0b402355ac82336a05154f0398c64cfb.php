    ...
    <div class="container py-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb product-breadcrumb mb-0 align-items-center">
                ...
                <?php if($sanPham->category): ?>
                    <?php $__currentLoopData = $sanPham->category->getAncestors(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ancestor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="breadcrumb-item">
                            <a href="<?php echo e(url('/Shop?danh_muc[]=' . $ancestor->id)); ?>" class="text-decoration-none text-muted small">
                                <?php echo e($ancestor->ten_danh_muc); ?>

                            </a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(url('/Shop?danh_muc[]=' . $sanPham->category->id)); ?>" class="text-decoration-none text-muted small">
                ...
                <div class="product-gallery-sticky">
                    <div class="product-media-wrapper gallery-entrance position-relative overflow-hidden rounded-4 bg-light border border-light-subtle">
                        ...
                        <div class="product-image-container ratio ratio-1x1 d-flex align-items-center justify-content-center">
                            <img src="<?php echo e($sanPham->hinh_anh_chinh ? asset('storage/' . $sanPham->hinh_anh_chinh) : asset('img/shop_01.jpg')); ?>"
                                 id="main-product-img"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const galleryImages = <?php echo json_encode($galleryImages->all()); ?>;
        ...
        function updateGallery(selectedColorId = null) {
            ...
            images.forEach((galleryImage, index) => {
                ...
                thumbnailImage.alt = '<?php echo e(addslashes($sanPham->ten_san_pham)); ?>';
